...
class NodeBuilder:
    ...
    def with_energy_parameters(self, capacitance, von, voff, eadv, v_max_thr):
    ...
    def build(self) -> Node:
        ...
        if self._capacitance is None or self._von is None or self._voff is None or self._eadv is None or self._v_max_thr is None:
            raise ValueError("Energy parameters (capacitance, von, voff, eadv, v_max_thr) are required")
